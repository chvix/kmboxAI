...
def get_args_parser(add_help=True):
    ...
    parser.add_argument('--yaml', type=str, default='data/kmbox.yaml', help='data yaml file.')
    parser.add_argument('--img-size', nargs='+', type=int, default=[416, 416], help='the image-size(h,w) in inference size.')
