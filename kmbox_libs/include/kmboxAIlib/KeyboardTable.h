...
int getKeyHexByName(const char *str);
void soft_keydown(int value,const char *str_name);
void soft_keyup(int value,const char *str_name);
void soft_keypress(int value,const char *str_name,int t1);
int  check_keyisdown(int value,const char *str_name);
void showTable();
int soft_mask(int value,const char *str_name,int val);
int soft_ismask(int value,const char *str_name);
int soft_String(const char * string);
#endif